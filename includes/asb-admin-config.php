...
function asb_set_plugin_meta( $links, $file ) {
	...
	if ( strpos( $file, 'simple-social-bookmarks.php' ) !== false ) {
		$links = array_merge( $links, array( '<a href="https://wordpress.org/support/plugin/simple-social-bookmarks">' . __( 'Support', 'social-bookmarks' ) . '</a>' ) );
		$links = array_merge( $links, array( '<a href="http://www.artiss.co.uk/donate">' . __( 'Donate', 'social-bookmarks' ) . '</a>' ) );
	}
