...
function simple_social_bookmarks($url,$twitter_text,$style,$add_paras) {
    ...
    if (($option=="on")or(($default=="on")&&($option!="off"))) {
        $echoout.="<a href=\"http://www.google.com/reader/link?url=".$url."&amp;title=".$title."\" target=\"".$target."\"".$nofollow."><img src=\"".$icon_folder."gbuzz.png\" alt=\"Add to Google Buzz\" title=\"Add to Google Buzz\" style=\"".$style."\"/></a>\n";
    }
